...
export default class ConnectionOutDoc implements SocketDoc<LifecycleHistoryConnection> {
    title = 'Connect';
...
export type ConnectDocOutPayload = LifecycleHistoryConnection | PartialState;
